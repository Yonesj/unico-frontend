                    ...
                    <div className='h-[480px] lg:h-full overflow-hidden w-full sm:w-8/12 lg:w-full   border-2 border-solid border-white relative flex flex-col gap-9 lg:gap-0 xl:gap-32 lg:pr-[3%] lg:flex-row  rounded-xl py-10 ' >
                        <div className='flex flex-col items-center px-3 md:px-7 gap-8 lg:gap-0'>
                            <div className='flex gap-2 md:gap-6 w-full lg:w-full '>
                                ...
                                <div className='text-sm'>
                                    ...
                                    <p className='text-xs md:text-sm mt-3 mb-2'>دانشکده  {professorDetails.faculty}</p>
                                    <div className='flex gap-2 flex-wrap'>
                                        {professorDetails.courses?.map((course, index) => {

                                            return (
                                                <div key={course.id} className='font-iransansfa flex items-center gap-2 font-normal text-xs lg:text-sm text-[#949494]'>
                                                    <p>{course.name}</p>

                                                    {index !== professorDetails.courses.length - 1 ? <svg xmlns="http://www.w3.org/2000/svg" width="3" height="4" viewBox="0 0 3 4" fill="none">
                                                        <circle cx="1.5" cy="2" r="1.5" fill="#D9D9D9" />
                                                    </svg> : ""}
                                                </div>
                                            )
                            ...
                            <div className='flex gap-4  lg:mt-12 w-full  lg:w-auto '>
                                <button onClick={() => navigate(`/poll/ProfessorDetails/${id}/comment`)} style={{ background: 'linear-gradient(90deg, #33BDC4 0%, #3C6AA0 100%)' }} className='h-9 lg:h-[52px] w-1/2  lg:w-[187px] rounded-md lg:rounded-xl  text-white justify-center gap-2 flex items-center'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <div className='flex flex-col gap-4 font-iransansfa text-xs md:text-sm items-center px-3 md:px-7 text-[#3C3C3C]'>
                            ...
                            <div className='flex items-center w-full  lg:w-full gap-3.5'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                                    <rect width="28" height="28" rx="6" fill="#F4F7F8" />
                                    <path d="M14 6.5C15.9891 6.5 17.8968 7.29018 19.3033 8.6967C20.7098 10.1032 21.5 12.0109 21.5 14C21.5 15.9891 20.7098 17.8968 19.3033 19.3033C17.8968 20.7098 15.9891 21.5 14 21.5" stroke="#64748B" stroke-width="1.5" strokeLinecap="round" stroke-linejoin="round" />
                                    <path d="M14 21.5C12.0109 21.5 10.1032 20.7098 8.6967 19.3033C7.29018 17.8968 6.5 15.9891 6.5 14C6.5 12.0109 7.29018 10.1032 8.6967 8.6967C10.1032 7.29018 12.0109 6.5 14 6.5" stroke="#64748B" stroke-width="1.5" strokeLinecap="round" stroke-linejoin="round" />
                            ...
                            <div className='flex items-center w-full  lg:w-full gap-3.5'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                                    <rect width="28" height="28" rx="6" fill="#F4F7F8" />
                                    <path d="M11.5967 15.8223C8.635 16.2123 6.5 17.2998 6.5 18.5831C6.5 20.1939 9.8575 21.4998 14 21.4998C18.1425 21.4998 21.5 20.1939 21.5 18.5831C21.5 17.2998 19.365 16.2123 16.4033 15.8223" stroke="#64748B" stroke-width="1.5" strokeLinecap="round" stroke-linejoin="round" />
                            ...
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="142" height="74" viewBox="0 0 142 74" fill="none">
                                    <g clip-path="url(#clip0_15302_34349)">
                                        ...
                                        <path d="M45.5454 65.1238L42.8698 65.4993C41.4301 65.7002 40.1021 64.6989 39.8983 63.2562L32.5781 11.0682C32.3743 9.62544 33.3768 8.29472 34.8165 8.0905L86.2488 0.850578C87.6885 0.646359 89.0165 1.65099 89.2203 3.0937C89.2203 3.0937 89.687 6.43039 89.8481 7.57995" stroke="#A7A9AD" stroke-width="2" strokeLinecap="round" />
                                        <path d="M90.3936 10.6133L90.7223 12.6687" stroke="#A7A9AD" stroke-width="2" strokeLinecap="round" />
