...
export default function DeleteCourseDialogConfirmation({ isOpen, onClose, onConfirm }) {
  return (
          ...
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-xl border-2 border-solid border-secondary bg-primary-dark p-6 text-white shadow-xl transition-all">
                <Dialog.Title as="h3" className="w-full text-start text-lg font-medium">
                  حذف درس
                </Dialog.Title>
                <div className="mt-2 w-full">
                  <p className="text-start text-sm text-grey-200">آیا از حذف این درس اطمینان دارید؟</p>
                </div>
