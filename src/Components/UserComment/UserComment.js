    ...
    return (
        <div className='w-full pb-6  lg:p-6  rounded-xl font-iransansfa '>
            ...
            <div className='flex flex-col  lg:flex-row gap-10 items-center my-7'>
                ...
                <div className='w-full h-[180px] lg:w-[65%] flex flex-col text-xs lg:text-base '>
                    <h4 className={`text-[#2BAE58] font-semibold ${comment.would_take_again ? "text-[#2BAE58]" : "text-red-500"} `}>{comment.would_take_again ? "دوباره این استاد رو برمیدارم" : "دوباره این استاد رو بر نمیدارم"}</h4>
