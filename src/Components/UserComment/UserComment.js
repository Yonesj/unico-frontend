        ...
        <div className='w-full  lg:p-6  rounded-xl font-iransansfa '>
            <div className='flex justify-between items-center'>
                <div className='flex  gap-2 lg:gap-4 items-center'>
                    ...
                    <p className='text-[#1B1B1B] text-[13px] lg:text-base  font-semibold'>درس برنامه نویسی پیشرفته</p>
                </div>
                <div>
                    <p className='font-normal text-[#6F6F6F] text-[11px] lg:text-sm'>5 فروردین 1404</p>
                </div>
            </div>
            <div className='flex flex-col  lg:flex-row gap-10 items-center my-7'>
                <div className='h-[180px] w-full lg:w-[35%] flex flex-col text-xs text-[#6C6C6C]  justify-between text-nowrap'>
                    ...
                    <div className='flex gap-3 items-center'>
                        ...
                        <Progressbar strok={6} value={15} />
                        <p className="hidden md:block">دست باز و با ارفاق</p>
                    </div>
                    <div className='flex gap-3 items-center'>
                        <p className='w-[99px] text-xs  text-black'>سختی امتحان</p>
                        <Progressbar strok={6} value={10} />
                        <p className="hidden md:block">دست باز و با ارفاق</p>
                    </div>
                </div>
                <div className='w-full lg:w-[65%] flex flex-col text-xs lg:text-base '>
                    <h4 className='text-[#2BAE58] font-semibold '>دوباره این استاد رو برمیدارم</h4>
                    <div className='flex flex-col lg:flex-row w-full gap-2.5 lg:gap-8 lg:items-center mt-4 mb-5'>
                        <p>حضور غیاب: میکند</p>
                        <p>نمره دانشجو: <span className='font-semibold'>19.5</span></p>
                        <p>منابع امتحان: <span className='font-semibold'>کتاب و جزوه</span></p>
                    </div>
                    <p className='text-[#181818]'>استاد باسواد و بااخلاقی است که تدریس خوبی  دارد، اما گاهی تند درس می‌دهد و سوالات امتحانش سخت‌تر از مطالب کلاس است. برخی دانشجویان از نمره‌دهی سختگیرانه‌اش گله دارند، ولی اگر فعال باشید و تمرین حل کنید، شانس قبولی خوبی دارید. به طور کلی، اگر دنبال یادگیری  عمیق هستید، انتخاب خوبی است، ولی باید برای امتحانات سخت آماده باشید. استاد باسواد و بااخلاقی است که تدریس خوبی  دارد.</p>
                </div>
            </div>
