  ...
  return (
    <div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2  lg:grid-cols-3 xl:grid-cols-4 gap-[18px] h-[280px] overflow-hidden items-center'>
       ...
       <CommentCard first_name = {commentList[0]?.professor?.first_name} last_name = {commentList[0]?.professor.last_name} id = {commentList[0]?.professor?.id} review_text = {commentList[0]?.review_text} profile_image = {commentList[0]?.profile_image} />
       <CommentCard first_name = {commentList[1]?.professor?.first_name} last_name = {commentList[1]?.professor.last_name} id = {commentList[1]?.professor?.id} review_text = {commentList[1]?.review_text} profile_image = {commentList[1]?.profile_image} />
       <CommentCard first_name = {commentList[2]?.professor?.first_name} last_name = {commentList[2]?.professor.last_name} id = {commentList[2]?.professor?.id} review_text = {commentList[2]?.review_text} profile_image = {commentList[2]?.profile_image} />
       <CommentCard first_name = {commentList[3]?.professor?.first_name} last_name = {commentList[3]?.professor.last_name} id = {commentList[3]?.professor?.id} review_text = {commentList[3]?.review_text} profile_image = {commentList[3]?.profile_image} />


      </div>
       : 
      <div className='grid grid-cols-1 md:grid-cols-2  lg:grid-cols-3 xl:grid-cols-4 gap-[18px] h-[290px] overflow-hidden items-center'>
